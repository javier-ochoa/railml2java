 ...
 *       &lt;sequence&gt;
 *         &lt;element name="range" type="{https://www.railml.org/schemas/3.2}ItineraryRange" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/extension&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
    ...
    extends TElementWithID
{
    ...
    protected List<ItineraryRange> range;
     ...
     * 
     */
    public List<ItineraryRange> getRange() {
        if (range == null) {
            range = new ArrayList<ItineraryRange>();
        }
        return this.range;
    }
